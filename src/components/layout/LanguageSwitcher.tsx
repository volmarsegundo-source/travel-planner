      ...
      >
        ...
        {tooltipVisible && (
          <div
            id={tooltipId}
            role="tooltip"
            className="absolute z-50 top-full left-1/2 -translate-x-1/2 mt-2 px-3 py-2 text-xs font-atlas-body text-atlas-on-primary bg-atlas-primary rounded-lg shadow-lg max-w-[250px] text-center whitespace-normal pointer-events-none motion-reduce:transition-none"
          >
            {t("tooltip")}
            <div
              className="absolute bottom-full left-1/2 -translate-x-1/2 border-4 border-transparent border-b-atlas-primary"
              aria-hidden="true"
            />
          </div>
        )}
