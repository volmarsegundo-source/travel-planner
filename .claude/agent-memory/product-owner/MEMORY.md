...
- SPEC-PROD-AI-GOVERNANCE-V2 (Central de Governanca de IA): Sprint 45. Aba "IA" no /admin, feature flag AI_GOVERNANCE_V2. Roles admin-ai + admin-ai-approver. Ciclo de vida de prompts (draft→eval→aprovacao→rollback), gate Trust Score >=0.80, curadoria 5% outputs, kill-switches por tipo de geracao, audit log imutavel 90 dias, rate limit 10 edicoes/hora/admin. 48 ACs em 11 blocos. Modelos homologados: Gemini 2.0 Flash, Gemini 2.5 Flash (com aviso RISK-011), Opus 4.7, Sonnet 4.6, Haiku 4.5. Stored in `docs/specs/SPEC-PROD-AI-GOVERNANCE-V2.md`
