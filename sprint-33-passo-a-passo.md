# Sprint 33 — Passo a Passo de Execução

> Guia prático para executar o Sprint 33 (Fundação do Design System) no Claude Code.
> Pré-requisito: commit `ab97c5e` com os exports do Stitch já no repositório.
...
Estamos iniciando o Sprint 33 — "Fundação do Design System".
...
O PO criou as tasks do Sprint 33 — Fundação do Design System.
...
4. Leia atlas-design-migration-plan.md seção 3 (Guardrails) e seção 4 (Sprint 33)
...
Todos os 2172+ testes existentes devem continuar verdes.
...
Todos os 121+ testes devem passar — nenhum visual mudou neste sprint.
...
Sprint 33 está em fase de validação final.
...
### 5.4 Checklist de validação do Sprint 33
...
Valide o Sprint 33 com esta checklist:

SDD & DESIGN:
- [ ] Spec do Sprint 33 aprovada com as 9 dimensões (PROD, UX, TECH, SEC, AI, QA, INFRA, RELEASE, COST)
...
Gere o sprint review do Sprint 33 — Fundação do Design System.
Inclua: tasks completadas, métricas de testes (antes/depois), 
componentes criados, parecer do UX Designer, e status para o Sprint 34.
Salve em docs/sprint-reviews/SPRINT-33-REVIEW.md
```
...
Crie a release v0.28.0 com tag e changelog.
Título: "Design System Foundation"
Escopo: infraestrutura de design, component library, feature flags.
Nenhuma mudança visual — apenas fundação para sprints 34-36.
```
...
## ETAPA 7 — Preparar Sprint 34

Após fechar o Sprint 33, o próximo passo é o Sprint 34 (Landing Page + Login V2).
...
- O sprint 33 tem risco zero se seguido corretamente (nenhum visual muda)
...
- A substituição completa acontece nos Sprints 34-35 quando as telas V2 entram
...
- Nos Sprints 34-36, o UX Designer compara cada tela V2 com o screen.png do Stitch
